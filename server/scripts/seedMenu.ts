...
const amigos = menu()
    .restaurant('Amigos', 'Central Dining Hall - Student Gathering Place', '+1-607-871-2111')
    .addGroup(
        group()
            .name('Meals')
            .order(1)
            .addItem(
                item()
                    .name('Build-A-Bowl Meal')
                    .description('Customizable bowl with base, protein, 4 toppings, cheese, and sauce. Includes side and fountain drink.')
                    .price(19.00)
                    .image('/images/menu/amigos-bowl.jpg')
                    .prepTime(12)
                    .addExtra(
                        extra()
                            .name('Base')
                            ...
                            .maxSelectable(1)
                            .order(1)
                            .addExtra(extra().name('Jasmine Rice').price(0).order(1))
                            .addExtra(extra().name('Brown Rice').price(0).order(2))
                            .addExtra(extra().name('Romaine Lettuce').price(0).order(3))
                    )
                    .addExtra(
                        extra()
                            .name('Protein')
                            ...
                            .maxSelectable(1)
                            .order(2)
                            .addExtra(extra().name('Steak').price(0).order(1))
                            .addExtra(extra().name('Chicken').price(0).order(2))
                            .addExtra(extra().name('Chorizo').price(0).order(3))
                            .addExtra(extra().name('Seasoned Beef').price(0).order(4))
                            .addExtra(extra().name('Fried Egg').price(0).order(5))
                            .addExtra(extra().name('Tofu').price(0).order(6))
                    )
                    .addExtra(
                        extra()
                            .name('Cheese')
                            ...
                            .maxSelectable(1)
                            .order(3)
                            .addExtra(extra().name('Feta').price(0).order(1))
                            .addExtra(extra().name('Monterey Jack').price(0).order(2))
                            .addExtra(extra().name('Gorgonzola Crumbles').price(0).order(3))
                            .addExtra(extra().name('None').price(0).order(4))
                    )
                    .addExtra(
                        extra()
                            .name('Sauce')
                            ...
                            .maxSelectable(1)
                            .order(4)
                            .addExtra(extra().name('Buffalo').price(0).order(1))
                            .addExtra(extra().name('Chimichurri').price(0).order(2))
                            .addExtra(extra().name('Jalapeño Ranch').price(0).order(3))
                            .addExtra(extra().name('Salsa').price(0).order(4))
                            .addExtra(extra().name('Sesame').price(0).order(5))
                            .addExtra(extra().name('Sour Cream').price(0).order(6))
                            .addExtra(extra().name('Tzatziki').price(0).order(7).unavailable())
                    )
                    .addExtra(
                        extra()
                            .name('Side')
                            ...
                            .maxSelectable(1)
                            .order(5)
                            .addExtra(extra().name('Nachos').price(0).order(1))
                            .addExtra(extra().name('Caesar Salad').price(0).order(2))
                            .addExtra(extra().name('Rice').price(0).order(3))
                            .addExtra(extra().name('Sautéed Vegetables').price(0).order(4))
                    )
            )
            .addItem(
                item()
                    .name('Burrito Meal')
                    .description('Choice of chicken, steak, chorizo, seasoned beef, or veggie. Includes side and fountain drink.')
                    .price(15.50)
                    .image('/images/menu/amigos-burrito.jpg')
                    .prepTime(10)
                    .addExtra(
                        extra()
                            .name('Protein')
                            ...
                            .maxSelectable(1)
                            .order(1)
                            .addExtra(extra().name('Chicken').price(0).order(1))
                            .addExtra(extra().name('Steak').price(0).order(2))
                            .addExtra(extra().name('Chorizo Sausage').price(0).order(3))
                            .addExtra(extra().name('Seasoned Beef').price(0).order(4))
                            .addExtra(extra().name('Southwestern Veggie').price(0).order(5))
                    )
                    .addExtra(
                        extra()
                            .name('Side')
            ...
            .addItem(
                item()
                    .name('Quesadilla Meal')
                    .description('Choice of cheese, chicken, steak, or chorizo. Includes side and fountain drink.')
                    .price(15.00)
                    .image('/images/menu/amigos-quesadilla.jpg')
                    .prepTime(10)
                    .addExtra(
                        extra()
                            .name('Filling')
                            ...
                            .maxSelectable(1)
                            .order(1)
                            .addExtra(extra().name('Cheese').price(0).order(1))
                            .addExtra(extra().name('Chicken').price(0).order(2))
                            .addExtra(extra().name('Steak').price(0).order(3))
                            .addExtra(extra().name('Chorizo Sausage').price(0).order(4))
                    )
                    .addExtra(
                        extra()
                            .name('Side')
            ...
            .addItem(
                item()
                    .name('3-Taco Meal')
                    .description('Three tacos with choice of beef, chicken, or steak. Hard or soft shell. Includes side and fountain drink.')
                    .price(13.00)
                    .image('/images/menu/amigos-tacos.jpg')
                    .prepTime(10)
                    .unavailable()
                    .addExtra(
                        extra()
                            ...
                            .maxSelectable(1)
                            .order(1)
                            .addExtra(extra().name('Beef').price(0).order(1))
                            .addExtra(extra().name('Chicken').price(0).order(2))
                            .addExtra(extra().name('Steak').price(0).order(3))
                    )
                    .addExtra(
                        extra()
                            ...
                            .maxSelectable(1)
                            .order(2)
                            .addExtra(extra().name('Hard Shell').price(0).order(1))
                            .addExtra(extra().name('Soft Shell').price(0).order(2))
                    )
                    .addExtra(
                        extra()
                            .name('Side')
    ...
    .addGroup(
        group()
            ...
            .addItem(
                item()
                    .name('Individual Tacos')
                    .description('Choice of beef, chicken, or steak. Hard or soft shell. Topped with lettuce, tomato, Monterey Jack cheese, salsa, and sour cream.')
                    .price(11.50)
                    .image('/images/menu/amigos-individual-taco.jpg')
                    .prepTime(8)
                    .addExtra(
                        extra()
                            .name('Protein')
    ...
    .addGroup(
        group()
            ...
            .addItem(
                item()
                    .name('Burrito')
                    .description('Choice of chicken, steak, chorizo, seasoned beef, or southwestern veggie.')
                    .price(12.25)
                    .image('/images/menu/amigos-burrito-single.jpg')
                    .prepTime(8)
                    .addExtra(
                        extra()
                            .name('Protein')
    ...
    .addGroup(
        group()
            ...
            .addItem(
                item()
                    .name('Quesadilla')
                    .description('Choice of cheese, chicken, steak, or chorizo.')
                    .price(13.00)
                    .image('/images/menu/amigos-quesadilla-single.jpg')
                    .prepTime(8)
                    .addExtra(
                        extra()
                            .name('Filling')
    ...
    .addGroup(
        group()
            ...
            .addItem(
                item()
                    .name('Build-A-Bowl')
                    .description('Customizable bowl with base, protein, 4 toppings, cheese, and sauce.')
                    .price(15.00)
                    .image('/images/menu/amigos-bowl-single.jpg')
                    .prepTime(10)
                    .addExtra(
                        extra()
                            .name('Base')
                    ...
                    .addExtra(
                        extra()
                            ...
                            .addExtra(extra().name('Sesame').price(0).order(5))
                            .addExtra(extra().name('Sour Cream').price(0).order(6))
                            .addExtra(extra().name('Tzatziki').price(0).order(7))
                    )
            )
    )
    .addGroup(
        group()
            ...
            .addItem(
                item()
                    ...
                    .price(4.00)
                    .image('/images/menu/amigos-nachos.jpg')
                    .prepTime(5)
            )
            .addItem(
                item()
                    ...
                    .price(3.50)
                    .image('/images/menu/amigos-caesar.jpg')
                    .prepTime(3)
                    .vegetarian()
            )
            .addItem(
                item()
                    ...
                    .price(3.00)
                    .image('/images/menu/amigos-rice.jpg')
                    .prepTime(2)
                    .vegan()
            )
            .addItem(
                item()
                    ...
                    .price(3.50)
                    .image('/images/menu/amigos-vegetables.jpg')
                    .prepTime(5)
                    .vegan()
            )
    )
        ...
        group()
            ...
            .addItem(
                item()
                    ...
                    .price(2.00)
                    .image('/images/menu/amigos-fountain.jpg')
                    .prepTime(1)
                    .maxPerOrder(5)
            )
            .addItem(
                item()
                    ...
                    .price(2.00)
                    .image('/images/menu/amigos-water.jpg')
                    .prepTime(1)
                    .maxPerOrder(5)
            )
    )
...
async function seedMenus() {
    try {
        ...
        const menus = [amigos, campusGrill, alfredCafe];
